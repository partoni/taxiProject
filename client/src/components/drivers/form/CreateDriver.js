...
return(
    ...
    <form className={styles.form} onSubmit={handleSubmit(onSubmit)}>
        ...
        {errors.callSign?<div style={{color:'red',margin:'-10px' }} >{errors.callSign.message}</div>:null}
        </div>
        <div className={styles.form__item}> 
            <label className={styles.form__field}>
                <input className={styles.form__input} {...register('driverName')} required/>
